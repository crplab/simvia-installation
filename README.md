...
```
SIMVIA_INSTALL=/opt/simvia; docker run --name simvia-installer -p 3333:3333 -e HYPHA_INSTALL=$SIMVIA_INSTALL -v $SIMVIA_INSTALL:$SIMVIA_INSTALL -v /var/run/docker.sock:/var/run/docker.sock -it mycesys/simvia-installer:2026.1
...
```
SIMVIA_INSTALL=~/simvia; docker run --name simvia-installer -p 3333:3333 -e HYPHA_INSTALL=$SIMVIA_INSTALL -v $SIMVIA_INSTALL:$SIMVIA_INSTALL -v /var/run/docker.sock:/var/run/docker.sock -it mycesys/simvia-installer:2026.1
