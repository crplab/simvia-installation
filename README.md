...
2.1 [Update with Simvia Installer](#21-update-with-simvia-installer)  
...
```
SIMVIA_INSTALL=/opt/simvia; docker run --name simvia-installer -p 3333:3333 -e HYPHA_INSTALL=$SIMVIA_INSTALL -v $SIMVIA_INSTALL:$SIMVIA_INSTALL -v /var/run/docker.sock:/var/run/docker.sock -it mycesys/simvia-installer:2026.2
...
```
SIMVIA_INSTALL=~/simvia; docker run --name simvia-installer -p 3333:3333 -e HYPHA_INSTALL=$SIMVIA_INSTALL -v $SIMVIA_INSTALL:$SIMVIA_INSTALL -v /var/run/docker.sock:/var/run/docker.sock -it mycesys/simvia-installer:2026.2
...
1. Download `config-migration_2025.3-2025.4.sh` script from the [repository](https://github.com/crplab/simvia-installation/tree/2025.4/allinone/config-migration_2025.3-2025.4.sh)
2. Run migration script
...
#### 2025.4 to 2026.1
**Update version**
1. Download `config-migration_2025.4-2026.1.sh` script from the [repository](https://github.com/crplab/simvia-installation/tree/2026.1/allinone/config-migration_2025.4-2026.1.sh)
2. Run migration script
...
1. Download `config-migration_2026.1-2026.2.sh` script from the [repository](https://github.com/crplab/simvia-installation/tree/2026.2/allinone/config-migration_2026.1-2026.2.sh)
2. Run migration script
...
WARN: guacamole (xApp) login page can be easily accessed from inside the Simvia, and default admin login (`guacadmin`) is widely known.
...
It is strongly recommended to change this password now, before first launch, or else you'll have to access login page from inside the Simvia to change it.
