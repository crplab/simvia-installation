#!/bin/bash
# This script perform update docker environments for Simvia
# from version 2026.1 to version 2026.2

set -e

# Default URL of the installation script on GitHub
GITHUB_URL="https://github.com/crplab/simvia-installation/archive/refs/heads/2026.2.zip"
...
cp "$UNZIP_DIR"/simvia-installation-2026.2/allinone/prepare-dirs.sh ./
cp "$UNZIP_DIR"/simvia-installation-2026.2/allinone/create_databasebackup.sh ./
cp "$UNZIP_DIR"/simvia-installation-2026.2/allinone/restore_database.sh ./
...
for i in guacamole 3d-service hub-auth hub-ui hypha-backend-dictionary hypha-bff hypha-core hypha-dashboard hypha-files hypha-gateway hypha-resources hypha-tags hypha-tasks hypha-ui hypha-workflow; do
  \cp -rf "$UNZIP_DIR"/simvia-installation-2026.2/$i/. ../$i
done
cp -f "$UNZIP_DIR"/simvia-installation-2026.2/allinone/dotkey ./
chmod +x dotkey

cp "$UNZIP_DIR"/simvia-installation-2026.2/allinone/docker-compose.yml ./
cp "$UNZIP_DIR"/simvia-installation-2026.2/allinone/licenses/*.default ./licenses/
cp -r "$UNZIP_DIR"/simvia-installation-2026.2/allinone/vault_config ./
cp "$UNZIP_DIR"/simvia-installation-2026.2/allinone/nginx.guacamole.conf ./
...
echo "DEFAULT_SUPER_ADMIN_EMAIL=admin@simvia.ru"
printf '\n'
