...
GITHUB_URL="https://github.com/crplab/simvia-installation/archive/refs/heads/2025.4.zip"
...
cp "$UNZIP_DIR"/simvia-installation-2025.4/allinone/prepare-dirs.sh ./
cp "$UNZIP_DIR"/simvia-installation-2025.4/allinone/create_databasebackup.sh ./
cp "$UNZIP_DIR"/simvia-installation-2025.4/allinone/restore_database.sh ./
...
for i in 3d-service hub-auth hub-ui hypha-backend-dictionary hypha-bff hypha-core hypha-dashboard hypha-files hypha-gateway hypha-resources hypha-tags hypha-tasks hypha-ui hypha-workflow; do
  \cp -rf "$UNZIP_DIR"/simvia-installation-2025.4/$i/. ../$i
done

# cp "$UNZIP_DIR"/simvia-installation-2025.4/allinone/docker-compose.yml ./
cp "$UNZIP_DIR"/simvia-installation-2025.4/allinone/licenses/support.default ./licenses/support.default
